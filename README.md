# AI_Image_Generator is a Image generator app based on the info user provide via prompt. It uses OpenAi API to generate images. User can create images, share them with the community and download them.
